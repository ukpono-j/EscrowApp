...
const Navbar = () => {
  ...
  return (
    <div className="pl-5 pr-5 font-[Inter] md:pl-[60px] md:pr-[60px] left-0  fixed z-30 top-0 pt-5 pb-5 w-full bg-[#192331] flex justify-between items-center">
      ...
      <div className="hidden text-[#fff] text-[16px] md:flex space-x-6 items-center">
      ...
      {isMenuOpen && (
        <div className="md:hidden text-[13px] pt-4 mb-5 text-[#fff] text-center fixed top-[90px] left-0 w-full h-full bg-[#192331] flex flex-col pl-5  pr-5  sm:pl-[60px] sm:pr-[60px] md:pl-[70px] md:pr-[70px]">
          <ScrollLink
            to="about"
            className="mt-4 mb-4"
            smooth={true}
          ...
          <Link
            to="/register"
            className=" flex mt-3  items-center justify-center px-7 py-3   rounded-full text-[#fff] text-[13px] bg-[transparent] hover:bg-[#B38939] border-2  border-[#B38939]"
          >
            Register
          </Link>
        </div>
