...
const FAQ = () => {
  return (
    <div className="h-[auto] faq bg-[#062333]   flex  w-[100%]  text-[#fff]  pr-5  pl-5  md:pl-[50px] md:pr-[50px] pt-14  pb-14   ">
      <div className="border w-[100%] h-[auto] bg-[#fff] rounded-3xl  m-5">
        {/* Accordion */}
      </div>
      <div className="w-[100%] h-[300px] m-5">
