...
const Hero = () => {
  return (
    <Box
      className="
     hero md:flex items-center justify-between md:pl-14 pl-5 pr-5 md:pr-14  md:pt-[140px] pt-[150px] md:pb-[50px]   h-[auto] w-[100%]"
    >
      <div className="md:max-w-[50%]  w-[100%] text-center md:text-left   h-[auto] md:pr-10 ">
        <Text className="md:text-[76px] hero_heading leading-[40px] md:leading-[70px] text-[46px] ">
          {" "}
      ...
      <div className="md:max-w-[50%]  w-[100%]  mt-7  md:mt-0 relative  flex  h-[auto]">
