        ...
        <div className="h-[auto]">
          ...
          >
            ...
            >
              ...
              <Text mt={4} fontSize="17px">
                Shopping online shouldn’t come with risks. With Sylo, your money stays safe until you’re completely satisfied.
              </Text>
              ...
              <ul className="list-disc list-inside leading-relaxed space-y-1">
                <li>Escrow holds funds until product or service is confirmed.</li>
                <li>Full transparency and control.</li>
                <li>Peace of mind in every purchase.</li>
              </ul>
              ...
              <div className="flex w-full">
                <Link
                  to="/register"
                  className="mt-5 flex rounded-full items-center font-bold justify-center px-8 py-3 text-[#fff] text-[17px] bg-[#B38939] border-2 border-[#B38939] login_btn"
                >
                  Get Started now
                </Link>
              </div>
          ...
          >
            ...
            >
              ...
              <Text mt={4} fontSize="17px">
                As a seller, you deserve guaranteed payments. With Sylo:
              </Text>

              <ul className="list-disc list-inside leading-relaxed space-y-1">
                <li>Buyer funds are locked in escrow before delivery.</li>
                <li>Payments are released immediately upon buyer confirmation.</li>
                <li>You’re protected from fake buyers and delays.</li>
              </ul>
              ...
              <Link
                to="/register"
                className="mt-5 rounded-full flex justify-center font-bold px-10 py-3 text-[#fff] text-[17px] bg-[#B38939] border-2 border-[#B38939] login_btn"
              >
                Get Started now
              </Link>
            </Box>
          ...
          >
            ...
            >
              ...
              <ul className="list-disc list-inside mt-3 leading-relaxed space-y-1">
                <li>All users are verified through robust KYC.</li>
                <li>Partnered with secure wallets and fraud prevention tools.</li>
                <li>Every transaction is monitored for legitimacy</li>
              </ul>
              ...
              <Link
                to="/register"
                className="mt-5 flex rounded-full items-center justify-center px-8 py-3 font-bold text-[#fff] text-[16px] bg-[#B38939] border-2 border-[#B38939] login_btn"
              >
                Get Started now
              </Link>
            </Box>
